...
console.log('loading OAuth libs')
...
module.exports = (server, db) => {
  ...
  server.get('/', (req, res) => {
    ...
    <body style='display: flex; align-items: center; justify-content: center; flex-direction: column;font-family: sans-serif'>
      <img src="https://firebasestorage.googleapis.com/v0/b/spud-reloaded.appspot.com/o/static%2Fradiospiral.png?alt=media&token=db323dc7-d68e-4cf0-a55b-1d3c338f8819"><h1><a href="http://radiospiral.net">RadioSpiral's <a href='https://github.com/joemcmahon/slapp-spudbot'>Spud</h1>
  ...
  console.log('establishing add to Slack')
  server.get('/add-to-slack', bodyParser.json(), (req, res) => {
    ...
    console.log('authenticating to Slack')
