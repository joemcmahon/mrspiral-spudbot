...
//    })
  ...
  app
    ...
    .message(/\b(hi|hey|hoi|yo|hai|hello|howdy|greetings|sup|good\s+(morning|day|afternoon|evening))\b/i, ['mention', 'direct_message'], (msg) => {
  msg.say(['hi there, how are you?','Heya, how\'s you?','sup dude','yo wassup','hello ambient, how are you?'])
   .route('handleHowAreYou')  // where to route the next msg in the conversation
    ...
    .message(/bye|nite|night|later|vista|goodbye|dreams|see you|bai|good night|ttfn|syl|nini/i, ['mention', 'direct_message'], (msg) => {
